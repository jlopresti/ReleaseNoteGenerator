    ...
    public static class JObjectExtensions
    {
        ...
        public static Type GetTypeProvider<T>(this JObject obj)
        {
            ...
            var types = AppDomain.CurrentDomain.GetAssemblies()
                ...
                .Where(p => p.GetTypeInfo().GetCustomAttributes(typeof(ProviderAttribute)).Cast<ProviderAttribute>().Any(x => x.Name.Equals(provider, StringComparison.CurrentCultureIgnoreCase)))
                .ToList();
